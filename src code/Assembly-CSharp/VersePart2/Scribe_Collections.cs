...
namespace Verse
{
	...
	{
		// Token: 0x06001B1B RID: 6939 RVA: 0x000A5C34 File Offset: 0x000A3E34
		...
		// Token: 0x06001B1C RID: 6940 RVA: 0x000A5C40 File Offset: 0x000A3E40
		...
		// Token: 0x06001B1D RID: 6941 RVA: 0x000A646C File Offset: 0x000A466C
		public static void Look<K, V>(ref Dictionary<K, V> dict, string label, LookMode keyLookMode = LookMode.Undefined, LookMode valueLookMode = LookMode.Undefined)
		{
			...
			List<K> list = null;
			List<V> list2 = null;
			Scribe_Collections.Look<K, V>(ref dict, label, keyLookMode, valueLookMode, ref list, ref list2, true);
		}

		// Token: 0x06001B1E RID: 6942 RVA: 0x000A64B0 File Offset: 0x000A46B0
						...
						else
						{
							...
							for (int i = 0; i < num; i++)
							{
								...
								else
								{
									...
									{
										V v;
										if (dict.TryGetValue(keysWorkingList[i], out v))
										{
											if (!object.Equals(v, valuesWorkingList[i]))
											{
		...
		// Token: 0x06001B1F RID: 6943 RVA: 0x000A6880 File Offset: 0x000A4A80
		...
		// Token: 0x06001B20 RID: 6944 RVA: 0x000A688C File Offset: 0x000A4A8C
		...
		// Token: 0x06001B21 RID: 6945 RVA: 0x000A6944 File Offset: 0x000A4B44
