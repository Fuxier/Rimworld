...
namespace Verse
{
	...
	{
		// Token: 0x0600216C RID: 8556 RVA: 0x000CE7EC File Offset: 0x000CC9EC
		[DebugOutput]
		...
		// Token: 0x0600216D RID: 8557 RVA: 0x000CE884 File Offset: 0x000CCA84
		[DebugOutput]
		...
		// Token: 0x0600216E RID: 8558 RVA: 0x000CECA8 File Offset: 0x000CCEA8
		[DebugOutput]
		...
		// Token: 0x0600216F RID: 8559 RVA: 0x000CEF90 File Offset: 0x000CD190
		[DebugOutput]
		...
		// Token: 0x06002170 RID: 8560 RVA: 0x000CF100 File Offset: 0x000CD300
		[DebugOutput]
		public static void HitsToKill()
		{
			Dictionary<ThingDef, <>f__AnonymousType2<ThingDef, float, int>> data = (from d in DefDatabase<ThingDef>.AllDefs
			where d.race != null
			select d).Select(delegate(ThingDef x)
			{
				...
				for (int i = 0; i < 15; i++)
				{
					Pawn pawn = PawnGenerator.GeneratePawn(new PawnGenerationRequest(x.race.AnyPawnKind, null, PawnGenerationContext.NonPlayer, -1, true, false, false, true, false, 1f, false, true, false, true, true, false, false, false, false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, null, null, null, null, null, 0f, DevelopmentalStage.Adult, null, null, null, false));
		...
		// Token: 0x06002171 RID: 8561 RVA: 0x000CF26C File Offset: 0x000CD46C
		[DebugOutput]
		public static void Prosthetics()
		{
			PawnGenerationRequest request = new PawnGenerationRequest(PawnKindDefOf.Colonist, Faction.OfPlayer, PawnGenerationContext.NonPlayer, -1, false, false, false, true, false, 1f, false, true, false, true, true, false, false, false, false, 0f, 0f, null, 1f, (Pawn p) => p.health.hediffSet.hediffs.Count == 0, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, null, null, null, null, null, 0f, DevelopmentalStage.Adult, null, null, null, false);
		...
		// Token: 0x06002172 RID: 8562 RVA: 0x000CF584 File Offset: 0x000CD784
		[DebugOutput]
