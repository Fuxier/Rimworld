...
namespace Verse
{
	...
	public static class PlayDataLoader
	{
		...
		// (get) Token: 0x06000581 RID: 1409 RVA: 0x0001E941 File Offset: 0x0001CB41
		...
		// Token: 0x06000582 RID: 1410 RVA: 0x0001E948 File Offset: 0x0001CB48
		...
		// Token: 0x06000583 RID: 1411 RVA: 0x0001EA8C File Offset: 0x0001CC8C
		private static void DoPlayLoad()
		{
			...
			try
			{
				BackstoryTranslationUtility.LoadAndInjectBackstoryData(LanguageDatabase.activeLanguage.AllDirectories, null);
			}
			finally
			{
				DeepProfiler.End();
			...
			try
			{
				...
				try
				{
					...
					DefDatabase<ThingCategoryDef>.ResolveAllReferences(true, true);
		...
		// Token: 0x06000584 RID: 1412 RVA: 0x0001F248 File Offset: 0x0001D448
