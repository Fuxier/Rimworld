...
namespace Verse
{
	...
	{
		// Token: 0x06002786 RID: 10118 RVA: 0x000FE72C File Offset: 0x000FC92C
		public override bool AppliesToVersion(int majorVer, int minorVer)
		{
			return majorVer == 0 && minorVer <= 18;
		}

		// Token: 0x06002787 RID: 10119 RVA: 0x000FE73C File Offset: 0x000FC93C
		...
		// Token: 0x06002788 RID: 10120 RVA: 0x000FFFE4 File Offset: 0x000FE1E4
		...
		// Token: 0x06002789 RID: 10121 RVA: 0x001000A4 File Offset: 0x000FE2A4
		public override void PostExposeData(object obj)
		{
			if (Scribe.mode == LoadSaveMode.PostLoadInit)
			{
				...
				{
					Log.Error(pawn.ToStringSafe<Pawn>() + " has null needs tracker even though he's not dead. Fixing...");
